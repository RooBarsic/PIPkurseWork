...
<head>
    ...
    <script type="text/javascript" src="../js/VerificationScript.js"></script>
    <script type="text/javascript" src="../js/EnterWithVk.js"></script>
</head>
<body>
            ...
            <main align="center">
                <div id="content" align="center">
                    <h2> Регистрация </h2>
                        ...
                        <button id="sendUser"> Зарегистрироваться </button>
                    <button id="enterWithVk"> Зарегистрироваться через Vk </button>
                </div>
            </main>
            </div>
        </td></tr>
